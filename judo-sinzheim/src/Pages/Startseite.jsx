    ...
    <>
      ...
      <section className="pt-8 pb-4 px-4 max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 flex flex-col md:flex-row gap-6 items-center">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left flex flex-col gap-4">
            ...
            <Link to="/Training">
              <button className="bg-[#C22B26] hover:scale-105 ease-in-out duration-300 cursor-pointer text-white px-12 py-2 rounded-full font-semibold">Zu den Trainingszeiten</button>
            </Link>
      ...
      <section className="py-2 px-4 max-w-4xl mx-auto">
        <div className="bg-white rounded-2xl shadow-sm p-6 flex flex-col md:flex-row-reverse gap-6 items-center">
          ...
          {/* Textinhalt */}
          <div className="w-full md:w-1/2 text-center md:text-left flex flex-col gap-4">
            <h2 className="text-2xl font-semibold">Unser Verein</h2>
            <p className="text-gray-700">
            ...
            <Link to="/UnserVerein">
              <button className="bg-[#C22B26] hover:scale-105 ease-in-out duration-300 cursor-pointer text-white px-12 py-2 rounded-full font-semibold">Mehr zum Verein</button>
            </Link>  
          </div>

...
// ✨ Accordion-Komponenten (modernisiert)
    ...
    <>
      <SmallHeroSection
        ...
        subline={
          <>
            Zu Ehren von{" "}
            <strong className="font-semibold">Harald Schneider</strong>, Gründer und erster Vorsitzender des Judo Club Sinzheim e.V.
          </>
        }
      />
